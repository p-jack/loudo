...
import { Entry, MapBase } from "loudo-ds-map-interfaces"
...
export abstract class MapsortBase<K extends {},V extends {}> {
  ...
  abstract range(start:K, end:K, include?:Include):Stash<V>
...
export interface MapsortChange<K extends {},V extends {}> extends MapsortBase<K,V>, Loud<Entry<K,V>> {}
